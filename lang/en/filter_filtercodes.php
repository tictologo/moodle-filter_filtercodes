...
$string['ayuda_docente'] = 'Centro de Ayuda Docentes';
$string['ayuda_estudiante'] = 'Centro de Ayuda Estudiantes';
$string['info_docente_presencial'] = 'Bienvenida al curso Docente PRESENCIAL';
$string['info_docente_distancia'] = 'Bienvenida al curso Docente DISTANCIA';
$string['info_estudiante_presencial'] = 'Bienvenida al curso Estudiante PRESENCIAL';
$string['info_estudiante_distancia'] = 'Bienvenida al curso Estudiante DISTANCIA';
$string['guia_docente_distancia'] = 'Guía de inicio para Docente DISTANCIA';
$string['guia_docente_presencial'] = 'Guía de inicio para Docente PRESENCIAL';
$string['guia_estudiante_distancia'] = 'Guía de inicio para Estudiante DISTANCIA';
$string['guia_estudiante_presencial'] = 'Guía de inicio para Estudiante PRESENCIAL';
$string['menu_aula_docente'] = 'Bloque-menú aula virtual para DOCENTES';
$string['menu_aula_estudiante'] = 'Bloque-menú aula virtual para ESTUDIANTES';
$string['url_booklick'] = 'Bases de datos académicas';
$string['filter_ucla_desc'] = '';