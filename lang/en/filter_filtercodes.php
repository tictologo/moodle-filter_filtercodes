...
$string['info_docente_presencial'] = 'Información para docente PRESENCIAL';
$string['info_estudiante_presencial'] = 'Información para estudiante PRESENCIAL';
$string['info_docente_distancia'] = 'Información para docente DISTANCIA';
$string['info_estudiante_distancia'] = 'Información para estudiante DISTANCIA';
$string['url_booklick'] = 'Bases de datos académicas';
$string['info_ucla_desc'] = 'Contenidos HTML personalizados para el campus virtual. Se reemplaza [firstname] por el nombre del usuario y [proxybooklick] por URL de consulta a las bases de datos académicas';
$string['toolbox_desc'] = 'Contenido del bloque HTML en pestaña 2 del tema Adaptable (Herramientas didácticas). Puedes usar [proxybooklick] y [firstname] para hacer sustituciones ';
$string['ayuda_desc'] = 'Contenido del bloque HTML en pestaña 3 del tema Adaptable (Centro de Ayuda). Puedes usar [firstname] y [idcurso] para hacer sustituciones ';
$string['info_presencial_desc'] = 'Contenido del etiqueta HTML que se muestra en sección 0 de cursos PRESENCIALES. Puedes usar [firstname] y [shortname] para hacer sustituciones. Empleando [mail] se genera la URL para redactar un nuevo mensaje.';
$string['info_distancia_desc'] = 'Contenido del etiqueta HTML que se muestra en sección 0 de cursos A DISTANCIA y VIRTUALES. Puedes usar [firstname] y [idcurso] para hacer sustituciones. Empleando [mail] se genera la URL para redactar un nuevo mensaje.';
